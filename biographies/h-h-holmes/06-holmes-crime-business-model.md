...
![សៀវភៅបញ្ជីគណនេយ្យអាជីវកម្ម និងប្លង់សំណង់របស់ H.H. Holmes (H.H. Holmes' Crime-as-a-Business Ledger & Design Sketches)](holmes_business_ledger.png)
...
បន្ទាប់ពីបញ្ចប់ការសិក្សា Holmes មិនបានបើកគ្លីនិកព្យាបាលជំងឺធម្មតានោះទេ ប៉ុន្តែគាត់បានចាប់អារម្មណ៍លើអាជីវកម្មលក់រថ និងឱសថស្ថាន ដែលជាកន្លែងផ្តល់ឱ្យគាត់នូវយុទ្ធសាស្ត្រគ្រប់គ្រងហិរញ្ញវត្ថុ និងអាជីវកម្មពិតប្រាកដ។
...
graph TD
    A["ទាក់ទាញជនរងគ្រោះ (Ads & World's Fair)<br/>Inbound Marketing"] --> B["ផ្ទេរទ្រព្យសម្បត្តិ & ក្លែងឯកសារ<br/>Asset & Identity Extraction"]
    B --> C["ឃាតកម្មជាប្រព័ន្ធ (Gas Chambers & Vaults)<br/>Industrialized Execution"]
    C --> D["រុញសាកសពតាមរន្ធ Chutes<br/>Conveyor Belt Logistics"]
    D --> E["កែច្នៃឆ្អឹង / រំលាយសាច់ក្នុង acid<br/>Product Refining in Cellar"]
    E --> F["លក់ឆ្អឹងឱ្យសាលាពេទ្យ (B2B Sales)<br/>B2B Skeleton Distribution"]
    E --> G["បើកលុយធានារ៉ាប់រងអាយុជីវិត<br/>Insurance Payout Recovery"]
